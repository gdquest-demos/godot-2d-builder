...
func _ready() -> void:
	...
	Log.log_error(Events.connect("hovered_over_entity", self, "_on_hovered_over_entity"), "Info GUI")
	Log.log_error(Events.connect("info_updated", self, "_on_info_updated"), "Info GUI")
	Log.log_error(Events.connect("hovered_over_recipe", self, "_on_hovered_over_recipe"), "Info GUI")
